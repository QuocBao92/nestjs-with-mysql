...
describe('ConfirmSessionService', () => {
    ...
    class SettingServiceMockError2 {
        public getValueByKeys = jest.fn((a) => {
            // case 15: Cannot get ValuebyKeys from settingService
            throw Error();
        });
    }
    ...
    class RepositoryMock {
        public findOne = jest.fn((a) => {
            // case 15: Cannot get ValuebyKeys from settingService
            if (a.where.session_id === '0070bc3ee1ade2df4daddc5584c10725672607bcf247d6b0efc91788bf87f8724d7d1e4589274a8709859c74cd421701b89db8a358f885d2d8d061caf26097b16') {
                return {
    ...
    describe('Case No 15: ConfirmSession with error cannot get ValuebyKeys from settingService', () => {
        it('Confirm Session', (done) => {
            const sessionItem = new RequestConfirmSessionId();
            sessionItem.sessionId = '0070bc3ee1ade2df4daddc5584c10725672607bcf247d6b0efc91788bf87f8724d7d1e4589274a8709859c74cd421701b89db8a358f885d2d8d061caf26097b16';
